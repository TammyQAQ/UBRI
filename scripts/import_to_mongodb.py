...
class MongoDBImporter:
    ...
    def __init__(self, 
                 mongodb_uri: str = "mongodb+srv://yitianw:<db_password>@cluster0.jvwt789.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",  # <-- Insert your password in place of <db_password>
